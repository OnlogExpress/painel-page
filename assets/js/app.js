...
function($) {
    ...
    provider.list = {
        ...
        datepicker: {
            ...
            js: ['bootstrap-datepicker/js/bootstrap-datepicker.min.js', 'bootstrap-datepicker/locales/bootstrap-datepicker.pt-BR.min.js', ]
        },
        ...
        jqueryui: {
            selector: 'jqueryui',
            callback: 'initFullscreen',
            css: ['jqueryui/jquery-ui.min.css', 'jqueryui/jquery-ui.theme.min.css'],
